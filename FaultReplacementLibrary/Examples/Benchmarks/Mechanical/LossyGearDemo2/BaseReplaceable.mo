...
model BaseReplaceable
  "Example to show combination of LossyGear and BearingFriction"
  extends Modelica.Icons.Example;
  Modelica.Units.SI.Power PowerLoss=gear.flange_a.tau*der(gear.flange_a.phi) + gear.flange_b.tau
      *der(gear.flange_b.phi) "Power lost in the gear";

  replaceable Modelica.Mechanics.Rotational.Components.LossyGear gear(
    ratio=2,
    lossTable=[0, 0.5, 0.5, 0, 0],
    useSupport=true) constrainedby Modelica.Mechanics.Rotational.Components.LossyGear annotation (Placement(transformation(extent={{-20,0},{
            0,20}})));
  ...
  Modelica.Mechanics.Rotational.Components.BearingFriction bearingFriction(tau_pos=[0, 0.5; 1,
