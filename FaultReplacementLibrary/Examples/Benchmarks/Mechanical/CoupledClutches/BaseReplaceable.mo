...
model BaseReplaceable "Drive train with 3 dynamically coupled clutches"
  ...
  Modelica.Mechanics.Rotational.Components.Inertia J1(
    ...
    w(start=10, fixed=true)) annotation (Placement(transformation(extent={{
            -70,-10},{-50,10}})));
  Modelica.Mechanics.Rotational.Sources.Torque torque(useSupport=true) annotation (Placement(
        transformation(extent={{-100,-10},{-80,10}})));
  replaceable Modelica.Mechanics.Rotational.Components.Clutch clutch1(peak=1.1, fn_max=20) constrainedby Modelica.Mechanics.Rotational.Components.Clutch annotation (
  ...
  Modelica.Mechanics.Rotational.Components.Inertia J2(
    ...
    w(fixed=true, start=0)) annotation (Placement(transformation(extent={{-10,
            -10},{10,10}})));
  Modelica.Mechanics.Rotational.Components.Clutch clutch2(peak=1.1, fn_max=20) annotation (
  ...
  Modelica.Mechanics.Rotational.Components.Inertia J3(
    ...
    w(fixed=true, start=0)) annotation (Placement(transformation(extent={{
            50,-10},{70,10}})));
  Modelica.Mechanics.Rotational.Components.Clutch clutch3(peak=1.1, fn_max=20) annotation (
...
equation
  ...
  connect(fixed.flange, torque.support) annotation (Line(points={{-90,-20},
          {-90,-11},{-90,-10}}));
  annotation (
    Documentation(info="<html><p>用法：本模型保留 MSL 4.0.0 官方 Example 的系统拓扑与图形，作为 replaceable 基准。通过 extends BaseReplaceable(redeclare ...) 创建故障场景，不需要修改其余连接。</p>
