...
model BaseReplaceable "Heating MOS Inverter"
  ...
  replaceable Modelica.Electrical.Analog.Semiconductors.PMOS H_PMOS(useTemperatureDependency=true)
  constrainedby Modelica.Electrical.Analog.Semiconductors.PMOS annotation (Placement(transformation(extent={{-40,40},{-20,60}})));
  replaceable Modelica.Electrical.Analog.Semiconductors.NMOS H_NMOS(useTemperatureDependency=true)
  constrainedby Modelica.Electrical.Analog.Semiconductors.NMOS annotation (Placement(transformation(extent={{-40,0},{-20,20}})));
...
annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,
          ...
          textColor={0,0,255})}), Documentation(info="<html><p>用法：本模型保留 MSL 4.0.0 官方 Example 的系统拓扑与图形，作为 replaceable 基准。通过 extends BaseReplaceable(redeclare ...) 创建故障场景，不需要修改其余连接。</p>
