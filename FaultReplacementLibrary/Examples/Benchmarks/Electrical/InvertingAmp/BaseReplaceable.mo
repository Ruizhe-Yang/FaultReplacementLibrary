...
model BaseReplaceable "Inverting amplifier"
  ...
  replaceable Modelica.Electrical.Analog.Ideal.IdealOpAmpLimited opAmp(
    out(i(start=0, fixed=false)))
    constrainedby Modelica.Electrical.Analog.Ideal.IdealOpAmpLimited annotation (Placement(transformation(extent={{0,-10},{20,10}})));
