...
model BaseReplaceable "Heating rectifier"
  extends Modelica.Icons.Example;
  replaceable Modelica.Electrical.Analog.Semiconductors.Diode HeatingDiode1(
      useTemperatureDependency=true, useHeatPort=true)
                constrainedby Modelica.Electrical.Analog.Semiconductors.Diode annotation (Placement(transformation(extent={{-20,40},{0,60}})));
