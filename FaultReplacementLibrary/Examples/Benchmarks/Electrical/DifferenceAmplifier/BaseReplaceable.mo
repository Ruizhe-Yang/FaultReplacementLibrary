...
model BaseReplaceable
  ...
  Modelica.Electrical.Analog.Basic.Ground Gnd4 annotation (Placement(transformation(extent={{85,-50},{95,
            -40}})));
  replaceable Modelica.Electrical.Analog.Examples.Utilities.Transistor Transistor1(ct(v(start=0, fixed=true))) constrainedby Modelica.Electrical.Analog.Examples.Utilities.Transistor annotation (Placement(transformation(extent=
            {{-60,-20},{-40,0}})));
