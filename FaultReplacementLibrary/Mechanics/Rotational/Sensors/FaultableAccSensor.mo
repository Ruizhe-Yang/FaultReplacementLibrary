...
model FaultableAccSensor "Independent fault-enhanced MSL 4.0.0 Rotational.AccSensor"
  extends Modelica.Mechanics.Rotational.Interfaces.PartialAbsoluteSensor;
  Modelica.Blocks.Interfaces.RealOutput a(unit="rad/s2") annotation(Placement(transformation(origin={0,-110},extent={{10,-10},{-10,10}},rotation=90)));
  ...
  Modelica.Units.SI.AngularVelocity w_internal;
...
equation
  ...
  w_internal=der(flange.phi);
  a_raw=der(w_internal);
