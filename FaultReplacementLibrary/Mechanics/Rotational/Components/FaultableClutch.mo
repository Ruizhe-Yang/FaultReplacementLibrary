...
model FaultableClutch "Clutch based on Coulomb friction"
  ...
  Modelica.Units.SI.Force fn "Normal force (fn=fn_max*f_normalized)";
...
equation
  ...
  annotation (Icon(
      ...
      Line(visible=useHeatPort,
        ...
        Text(extent={{55,90},{90,55}},textString="F",textColor={255,0,0})}), Documentation(info="<html><p>用法：将 FaultableClutch 按其 MSL 对应元件连接到系统中。faultMode=Normal 或 severity=0 表示名义行为；选择其他 faultMode，并设置 severity、faultStartTime、faultEndTime 和 transitionTime 后仿真故障响应。</p>
<p>
