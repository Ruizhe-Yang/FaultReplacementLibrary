...
model FaultableControlledIdealClosingSwitch "ControlledIdealClosingSwitch independent fault model"
...
equation
  ...
  annotation (defaultComponentName="switch",
    Documentation(info="<html><p>用法：将 FaultableControlledIdealClosingSwitch 按其 MSL 对应元件连接到系统中。faultMode=Normal 或 severity=0 表示名义行为；选择其他 faultMode，并设置 severity、faultStartTime、faultEndTime 和 transitionTime 后仿真故障响应。</p>
<p>
...
end FaultableControlledIdealClosingSwitch;
