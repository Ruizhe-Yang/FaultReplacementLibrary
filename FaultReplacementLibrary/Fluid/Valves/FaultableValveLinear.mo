...
model FaultableValveLinear "ValveLinear with inline opening faults"
  ...
  Modelica.Fluid.Valves.ValveLinear nominal(
    redeclare package Medium=Medium,
    dp_nominal=dp_nominal,m_flow_nominal=m_flow_nominal);
equation
