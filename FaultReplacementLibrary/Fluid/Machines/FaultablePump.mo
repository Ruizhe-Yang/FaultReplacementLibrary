...
model FaultablePump "Pump with shaft torque faults"
  ...
  type FaultMode=enumeration(Normal "正常", EfficiencyLoss "效率下降", BearingFrictionIncrease "轴承摩擦增加", ImpellerDamage "叶轮损伤", ShaftSeizure "泵轴抱死");
  ...
  parameter Modelica.Units.SI.RotationalDampingConstant seizureDamping=1e9;
  parameter Modelica.Units.SI.Frequency damageFrequency=20;
  Modelica.Units.SI.Torque faultTorque;
  Modelica.Fluid.Machines.Pump nominal(
    redeclare package Medium=Medium,N_nominal=N_nominal,
